...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnHardcode_click (View v){
        ...
        startActivity(new Intent(this, ActividadConFragmentHardcoded.class));
    ...
    public void btnDinamico_click(View v){
        ...
        if (fm.findFragmentById(R.id.contenedor_fragment)==null) {
            ...
            FragmentoDos frag = new FragmentoDos();
            ft.add(R.id.contenedor_fragment,frag);
            ft.commit();

        }else{

            Toast.makeText(this, "El fragmento ya esta cargado", Toast.LENGTH_LONG).show();
